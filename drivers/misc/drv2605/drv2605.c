...
static int drv2605_suspend(struct i2c_client *cl, pm_message_t mesg){

	struct drv2605_data *pDrv2605data = i2c_get_clientdata(cl);
...
static int  drv2605_resume(struct i2c_client *cl){
	struct drv2605_data *pDrv2605data = i2c_get_clientdata(cl);
