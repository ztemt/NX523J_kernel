...
static int ztemt_set_ce_cabc(int sat_val, int cabc_val)
{
	...
	if(ret == 0)
		ZTEMT_DISP_INFO("success to set sat as = %d ,cabc as = %d\n", sat_val ,cabc_val);
	else
		ZTEMT_DISP_INFO("failed to set sat and cabc");
	return ret;
}
        ...
        struct kobj_attribute *attr, const char *buf, size_t size)
{
	...
	if(!ztemt_disp_val.en_cabc) {
        ...
        if (ret == 0) {
                ztemt_disp_val.cabc = val;
                ZTEMT_DISP_INFO("success to set cabc as = %d\n", val);
        }
        return size;
}
	...
	struct kobj_attribute *attr, const char *buf, size_t size)
{
	...
	ZTEMT_DISP_INFO("saturation value = %d\n", val);
	...
	if (ret == 0) {
		ztemt_disp_val.saturation = val;
		ZTEMT_DISP_INFO("success to set saturation as = %d\n", val);
	}
	return size;
}

#ifdef CONFIG_NUBIA_LCD_JDI_R63452_1080P_5P5
static int ztemt_set_colortmp(void)
{
	int ret = 0;
	...
	ZTEMT_DISP_DEBUG("nubia_mdp_pcc_cfg_adjustable.r.r = %x",nubia_mdp_pcc_cfg_adjustable.r.r);
	ZTEMT_DISP_DEBUG("nubia_mdp_pcc_cfg_adjustable.g.g = %x",nubia_mdp_pcc_cfg_adjustable.g.g);
	ZTEMT_DISP_DEBUG("nubia_mdp_pcc_cfg_adjustable.b.b = %x",nubia_mdp_pcc_cfg_adjustable.b.b);

	ret = ztemt_mdss_pcc_config(&nubia_mdp_pcc_cfg_adjustable);
...
static int ztemt_set_colortmp(int ctmp_val)
{
	...
	ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_warm.r.r = %x",sharp_nt35595_1080p_5p0_pcc_cfg_warm.r.r);
	ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_warm.g.g = %x",sharp_nt35595_1080p_5p0_pcc_cfg_warm.g.g);
	ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_warm.b.b = %x",sharp_nt35595_1080p_5p0_pcc_cfg_warm.b.b);

	ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_natural.r.r = %x",sharp_nt35595_1080p_5p0_pcc_cfg_natural.r.r);
        ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_natural.g.g = %x",sharp_nt35595_1080p_5p0_pcc_cfg_natural.g.g);
        ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_natural.b.b = %x",sharp_nt35595_1080p_5p0_pcc_cfg_natural.b.b);

	ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_cool.r.r = %x",sharp_nt35595_1080p_5p0_pcc_cfg_cool.r.r);
        ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_cool.g.g = %x",sharp_nt35595_1080p_5p0_pcc_cfg_cool.g.g);
        ZTEMT_DISP_DEBUG("sharp_nt35595_1080p_5p0_pcc_cfg_cool.b.b = %x",sharp_nt35595_1080p_5p0_pcc_cfg_cool.b.b);
	switch (ctmp_val) {
		case COLORTMP_WARM:
	...
	struct kobj_attribute *attr, const char *buf, size_t size)
{
	...
	ZTEMT_DISP_INFO("colortmp val = %d\n", val);
	...
	//warm
		...
		nubia_mdp_pcc_cfg_adjustable.b.b = 0x8000 -0x12 * (val - 127);
	}
	//cool
	else if(val < 127) {
		//0x8000 - 0x750 * (127 - val) / 127;
		nubia_mdp_pcc_cfg_adjustable.r.r = 0x8000 - 0x0b * (127 - val);
		nubia_mdp_pcc_cfg_adjustable.g.g = 0x8000;
		nubia_mdp_pcc_cfg_adjustable.b.b = 0x8000;
	}

	ret = ztemt_set_colortmp();
	if (ret == 0) {
		ztemt_disp_val.colortmp = val;
		ZTEMT_DISP_INFO("success to set colortmp as = %d\n", val);
	}
	...
	struct kobj_attribute *attr, const char *buf, size_t size)
{
	...
	ZTEMT_DISP_INFO("colortmp debug val = %d\n", val);
...
void ztemt_disp_preference(void)
{
	...
	if (!boot_flag){
		boot_flag = 1;
		if(ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_warm.defult == 0){
			sharp_nt35595_1080p_5p0_pcc_cfg_warm.r.r = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_warm.red;
			sharp_nt35595_1080p_5p0_pcc_cfg_warm.g.g = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_warm.green;
			sharp_nt35595_1080p_5p0_pcc_cfg_warm.b.b = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_warm.blue;
		}
		if(ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_natural.defult == 0){
                        sharp_nt35595_1080p_5p0_pcc_cfg_natural.r.r = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_natural.red;
                        sharp_nt35595_1080p_5p0_pcc_cfg_natural.g.g = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_natural.green;
                        sharp_nt35595_1080p_5p0_pcc_cfg_natural.b.b = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_natural.blue;
		}
		if(ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_cool.defult == 0){
                        sharp_nt35595_1080p_5p0_pcc_cfg_cool.r.r = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_cool.red;
                        sharp_nt35595_1080p_5p0_pcc_cfg_cool.g.g = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_cool.green;
                        sharp_nt35595_1080p_5p0_pcc_cfg_cool.b.b = ztemt_mdss_dsi_ctrl->nubia_mdp_colortmp_cool.blue;
		}
	}
#ifdef CONFIG_NUBIA_LCD_JDI_R63452_1080P_5P5
	ret = ztemt_set_colortmp();
