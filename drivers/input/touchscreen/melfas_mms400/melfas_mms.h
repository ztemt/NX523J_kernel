...
#define TP_LOG_TAG "mms_ts"
#define TP_LOG_ON
//#define TP_DEBUG_ON

#ifdef  TP_LOG_ON
#define TP_LOG_ERROR(fmt, args...) printk(KERN_ERR "[%s] [%s: %d] "  fmt, \
	TP_LOG_TAG, __FUNCTION__, __LINE__, ##args)

#define TP_LOG_INFO(fmt, args...) printk(KERN_INFO "[%s] [%s: %d] "  fmt, \
		TP_LOG_TAG, __FUNCTION__, __LINE__, ##args)

    #ifdef  TP_DEBUG_ON

#define TP_LOG_DEBUG(fmt, args...) printk(KERN_DEBUG "[%s] [%s: %d] "  fmt, \
	TP_LOG_TAG, __FUNCTION__, __LINE__, ##args)
    #else
