...
static DEVICE_ATTR(cmd, 0220, NULL, mms_sys_cmd);
...
static DEVICE_ATTR(cmd_status, 0444, mms_sys_cmd_status, NULL);
...
static DEVICE_ATTR(cmd_result, 0444, mms_sys_cmd_result, NULL);
...
static DEVICE_ATTR(cmd_list, 0444, mms_sys_cmd_list, NULL);
