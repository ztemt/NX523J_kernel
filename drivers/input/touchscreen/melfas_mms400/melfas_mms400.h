...
#define MMS_USE_GESTURE_WAKEUP_MODE 1
...
//Firmware update
//#define INTERNAL_FW_PATH		"melfas/MMS458_V1.32_V1.51_V1.15_V1.15"	//path of firmware included in the kernel image (/firmware)
#define INTERNAL_A_FW_PATH		"melfas/MMS458_V1.32_V1.55_V1.24_V1.24"	//path of firmware included in the kernel image (/firmware)
#define INTERNAL_B_FW_PATH		"melfas/MMS458_V1.32_V1.57_V1.33_V1.33"	//path of firmware included in the kernel image (/firmware)
...
//Gesture type
#define DOUBLE_CLICK            24

//open/short test spec
#define MMS_OPEN_SHORT_LOW_LIM     114
#define MMS_OPEN_SHORT_HIGH_LIM    609
